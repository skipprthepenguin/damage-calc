...
const RBY: {[name: string]: SpeciesData} = {
  ...
  Aerodactyl: {
    types: ['Rock', 'Flying'],
    bs: {hp: 80, at: 115, df: 65, sp: 130, sl: 50},
    weightkg: 59,
  },
  Alakazam: {
    types: ['Psychic'],
  ...
  Machamp: {
    types: ['Fighting'],
    bs: {hp: 118, at: 145, df: 100, sp: 67, sl: 55},
    weightkg: 130,
  },
  Machoke: {
    types: ['Fighting'],
  ...
  'Nidoran-M': {
    types: ['Poison'],
    bs: {hp: 46, at: 57, df: 42, sp: 50, sl: 40},
    weightkg: 9,
    nfe: true,
  },
  Nidorina: {
  ...
  Nidorino: {
    types: ['Poison'],
    bs: {hp: 66, at: 92, df: 67, sp: 65, sl: 55},
    weightkg: 19.5,
    nfe: true,
  },
  Ninetales: {
  ...
  Poliwrath: {
    ...
    bs: {hp: 110, at: 95, df: 95, sp: 95, sl: 75},
    weightkg: 54,
  },
  Ponyta: {
    types: ['Normal', 'Fire'],
  ...
  Wigglytuff: {
    types: ['Normal'],
    bs: {hp: 148, at: 70, df: 60, sp: 55, sl: 65},
    weightkg: 12,
  },
  Zapdos: {
...
const GSC_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Ariados: {
    types: ['Bug', 'Poison'],
    bs: {hp: 95, at: 100, df: 75, sa: 50, sd: 75, sp: 80},
    weightkg: 33.5,
  },
  Azumarill: {
    types: ['Water'],
  ...
  Ledian: {
    types: ['Bug', 'Fighting'],
    bs: {hp: 85, at: 104, df: 55, sa: 23, sd: 113, sp: 95},
    weightkg: 35.6,
  },
  Ledyba: {
    types: ['Bug', 'Fighting'],
  ...
  Politoed: {
    types: ['Water'],
    bs: {hp: 125, at: 65, df: 70, sa: 115, sd: 95, sp: 70},
    weightkg: 33.9,
  },
  Porygon2: {
    types: ['Normal', 'Electric'],
...
const ADV_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Metagross: {
    types: ['Steel', 'Psychic'],
    bs: {hp: 80, at: 135, df: 125, sa: 85, sd: 85, sp: 70},
    weightkg: 550,
    gender: 'N',
    abilities: {0: 'Clear Body'},
  },
  ...
  Registeel: {
    types: ['Steel'],
    bs: {hp: 80, at: 100, df: 150, sa: 50, sd: 150, sp: 50},
    weightkg: 205,
    gender: 'N',
    abilities: {0: 'Clear Body'},
  },
  ...
  Shiftry: {
    types: ['Grass', 'Dark'],
    bs: {hp: 105, at: 120, df: 60, sa: 100, sd: 60, sp: 80},
    weightkg: 59.6,
    abilities: {0: 'Chlorophyll'},
  },
  Shroomish: {
...
const BW_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Stoutland: {
    types: ['Normal', 'Ground'],
    bs: {hp: 116, at: 118, df: 104, sa: 51, sd: 116, sp: 76},
    weightkg: 61,
    abilities: {0: 'Intimidate'},
  },
  Stunfisk: {
  ...
  Zebstrika: {
    types: ['Electric'],
    bs: {hp: 90, at: 100, df: 63, sa: 100, sd: 63, sp: 116},
    weightkg: 79.5,
    abilities: {0: 'Lightning Rod'},
  },
  Zekrom: {
...
const XY_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Clawitzer: {
    types: ['Water'],
    bs: {hp: 81, at: 73, df: 97, sa: 120, sd: 94, sp: 79},
    weightkg: 35.3,
    abilities: {0: 'Mega Launcher'},
  },
  Crucibelle: {
  ...
  Florges: {
    types: ['Fairy', 'Grass'],
    bs: {hp: 83, at: 73, df: 88, sa: 112, sd: 154, sp: 70},
    weightkg: 10,
    abilities: {0: 'Flower Veil'},
  },
  Froakie: {
...
const SM_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Drampa: {
    types: ['Normal', 'Dragon'],
    bs: {hp: 118, at: 50, df: 85, sa: 135, sd: 96, sp: 36},
    weightkg: 185,
    abilities: {0: 'Berserk'},
  },
  'Diglett-Alola': {
  ...
  'Eevee-Starter': {
    types: ['Normal'],
    bs: {hp: 65, at: 65, df: 65, sa: 45, sd: 75, sp: 70},
    weightkg: 6.5,
    abilities: {0: 'Run Away'},
    baseSpecies: 'Eevee',
  },
  ...
  'Golem-Alola': {
    types: ['Rock', 'Electric'],
    bs: {hp: 85, at: 50, df: 120, sa: 115, sd: 80, sp: 50},
    weightkg: 316,
    abilities: {0: 'Magnet Pull'},
    baseSpecies: 'Golem',
  },
  ...
  Mimikyu: {
    types: ['Ghost', 'Fairy'],
    bs: {hp: 65, at: 95, df: 83, sa: 50, sd: 105, sp: 96},
    weightkg: 0.7,
  ...
  Turtonator: {
    types: ['Fire', 'Dragon'],
    bs: {hp: 85, at: 68, df: 124, sa: 111, sd: 96, sp: 36},
    weightkg: 212,
    abilities: {0: 'Shell Armor'},
  },
  'Type: Null': {
  ...
  Vikavolt: {
    types: ['Bug', 'Electric'],
    bs: {hp: 77, at: 105, df: 80, sa: 155, sd: 90, sp: 88},
    weightkg: 45,
    abilities: {0: 'Levitate'},
...
const SS_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  'Coalossal-Gmax': {
    types: ['Rock', 'Fire'],
    bs: {hp: 110, at: 90, df: 120, sa: 90, sd: 90, sp: 30},
    weightkg: 0,
    abilities: {0: 'Steam Engine'},
  ...
  Dragapult: {
    types: ['Dragon', 'Ghost'],
    bs: {hp: 85, at: 108, df: 70, sa: 105, sd: 70, sp: 142},
    weightkg: 50,
    abilities: {0: 'Clear Body'},
  },
  Drakloak: {
  ...
  'Machamp-Gmax': {
    types: ['Fighting'],
    bs: {hp: 90, at: 130, df: 80, sa: 55, sd: 85, sp: 55},
    weightkg: 0,
    abilities: {0: 'Guts'},
    baseSpecies: 'Machamp',
  },
  ...
  Perrserker: {
    types: ['Steel', 'Dark'],
    bs: {hp: 77, at: 121, df: 91, sa: 30, sd: 102, sp: 19},
    weightkg: 28,
    abilities: {0: 'Battle Armor'},
  },
  'Pikachu-Gmax': {
...
const SV_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Armarouge: {
    types: ['Fire', 'Psychic'],
    bs: {hp: 100, at: 90, df: 115, sa: 135, sd: 85, sp: 75},
    weightkg: 85,
    abilities: {0: 'Flash Fire'},
  },
  Baxcalibur: {
  ...
  Munkidori: {
    types: ['Poison', 'Psychic'],
    bs: {hp: 88, at: 80, df: 66, sa: 125, sd: 90, sp: 106},
    weightkg: 12.2,
    abilities: {0: 'Toxic Chain'},
  },
  Nacli: {
  ...
  Sotanaht: {
    types: ['Ghost', 'Fire'],
    bs: {hp: 104, at: 106, df: 91, sa: 54, sd: 93, sp: 96},
		weightkg: 55,
    abilities: {0: 'Aftermath'},
  },
  Spidops: {
