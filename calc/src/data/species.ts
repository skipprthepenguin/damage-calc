...
const GSC_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Crobat: {
    types: ['Poison', 'Flying'],
    bs: {hp: 90, at: 121, df: 89, sa: 60, sd: 93, sp: 147},
    weightkg: 75,
  },
  Croconaw: {
    types: ['Water'],
  ...
  Entei: {
    types: ['Fire', 'Ground'],
    bs: {hp: 120, at: 95, df: 90, sa: 95, sd: 85, sp: 100},
    weightkg: 198,
    gender: 'N',
  },
  Espeon: {
...
const ADV_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Altaria: {
    types: ['Dragon', 'Fairy'],
    bs: {hp: 85, at: 45, df: 105, sa: 110, sd: 110, sp: 85},
    weightkg: 20.6,
  ...
  'Jirachi-NorthStar': {
    types: ['Ice', 'Fairy'],
    bs: {hp: 100, at: 100, df: 110, sa: 100, sd: 110, sp: 80},
    weightkg: 1.1,
  ...
  Metagross: {
    types: ['Steel', 'Psychic'],
    bs: {hp: 80, at: 135, df: 130, sa: 70, sd: 90, sp: 70},
    weightkg: 550,
    gender: 'N',
    abilities: {0: 'Clear Body'},
  },
  ...
  Salamence: {
    types: ['Dragon', 'Flying'],
    bs: {hp: 95, at: 110, df: 80, sa: 135, sd: 80, sp: 100},
    weightkg: 102.6,
    abilities: {0: 'Intimidate'},
  },
  Sceptile: {
...
const DPP_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Azelf: {
    ...
    bs: {hp: 75, at: 130, df: 75, sa: 130, sd: 75, sp: 115},
    weightkg: 0.3,
    abilities: {0: 'Levitate'},
    gender: 'N',
  },
  ...
  Bibarel: {
    types: ['Grass', 'Water'],
    bs: {hp: 89, at: 85, df: 80, sa: 70, sd: 80, sp: 81},
    weightkg: 31.5,
    abilities: {0: 'Simple'},
  },
  Bidoof: {
  ...
  Garchomp: {
    types: ['Dragon', 'Ground'],
    bs: {hp: 108, at: 130, df: 95, sa: 80, sd: 85, sp: 92},
    weightkg: 95,
    abilities: {0: 'Sand Veil'},
  },
  Gastrodon: {
  ...
  Luxray: {
    types: ['Electric', 'Dark'],
    bs: {hp: 89, at: 133, df: 94, sa: 88, sd: 94, sp: 102},
    weightkg: 42,
    abilities: {0: 'Rivalry'},
  },
  Magmortar: {
  ...
  Shaymin: {
    types: ['Grass', 'Fairy'],
    bs: {hp: 120, at: 80, df: 105, sa: 90, sd: 115, sp: 90},
    weightkg: 2.1,
    abilities: {0: 'Natural Cure'},
    gender: 'N',
  ...
  Uxie: {
    types: ['Psychic', 'Steel'],
    bs: {hp: 105, at: 60, df: 130, sa: 100, sd: 130, sp: 75},
    weightkg: 0.3,
    abilities: {0: 'Levitate'},
    gender: 'N',
  },
...
const BW_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Hydreigon: {
    types: ['Dark', 'Dragon'],
    bs: {hp: 97, at: 105, df: 95, sa: 110, sd: 95, sp: 98},
    weightkg: 160,
    abilities: {0: 'Levitate'},
  },
  Jellicent: {
  ...
  Stoutland: {
    types: ['Normal', 'Ground'],
    bs: {hp: 106, at: 123, df: 104, sa: 61, sd: 116, sp: 91},
    weightkg: 61,
    abilities: {0: 'Intimidate'},
  },
  Stunfisk: {
...
const XY_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Beedrill: {bs: {at: 125}, otherFormes: ['Beedrill-Mega']},
  ...
  Gardevoir: {types: ['Psychic', 'Fairy'], otherFormes: ['Gardevoir-Mega', 'Gardevoir-Olympios']},
  Gengar: {otherFormes: ['Gengar-Mega']},
  Gigalith: {bs: {sd: 80}},
  Glalie: {otherFormes: ['Glalie-Mega']},
  Golem: {bs: {at: 120}},
  Granbull: {types: ['Fairy'], otherFormes: ['Granbull-Mega']},
  ...
  Pidgeot: {bs: {sp: 95}, otherFormes: ['Pidgeot-Mega']},
  Pikachu: {
    bs: {df: 40, sd: 50},
    otherFormes: [
      'Pikachu-Belle',
  ...
  Clawitzer: {
    types: ['Water'],
    bs: {hp: 81, at: 73, df: 93, sa: 120, sd: 94, sp: 69},
    weightkg: 35.3,
    abilities: {0: 'Mega Launcher'},
  },
  Crucibelle: {
  ...
  Florges: {
    types: ['Fairy', 'Grass'],
    bs: {hp: 83, at: 88, df: 88, sa: 112, sd: 154, sp: 75},
    weightkg: 10,
    abilities: {0: 'Flower Veil'},
  },
  Froakie: {
  ...
  Goodra: {
    types: ['Dragon', 'Poison'],
    bs: {hp: 90, at: 105, df: 90, sa: 105, sd: 130, sp: 80},
    weightkg: 150.5,
    abilities: {0: 'Sap Sipper'},
  },
  Goomy: {
  ...
  Gourgeist: {
    ...
    weightkg: 12.5,
    abilities: {0: 'Pickup'},
    otherFormes: ['Gourgeist-Large', 'Gourgeist-Small', 'Gourgeist-Super','Gourgeist-Mega'],
  },
  'Gourgeist-Large': {
    types: ['Ghost', 'Grass'],
  ...
  'Aerodactyl-Mega': {
    types: ['Rock', 'Flying'],
    bs: {hp: 90, at: 135, df: 85, sa: 70, sd: 95, sp: 150},
    weightkg: 79,
    abilities: {0: 'Tough Claws'},
  ...
  'Alakazam-Mega': {
    types: ['Psychic'],
    bs: {hp: 55, at: 50, df: 65, sa: 175, sd: 105, sp: 135},
    weightkg: 48,
    abilities: {0: 'Trace'},
  ...
  'Altaria-Mega': {
    types: ['Dragon', 'Fairy'],
    bs: {hp: 85, at: 110, df: 115, sa: 125, sd: 115, sp: 90},
    weightkg: 20.6,
  ...
  'Blaziken-Mega': {
    types: ['Fire', 'Fighting'],
    bs: {hp: 80, at: 150, df: 85, sa: 135, sd: 85, sp: 95},
    weightkg: 52,
    abilities: {0: 'Leg Day'},
  ...
  'Camerupt-Mega': {
    types: ['Fire', 'Ground'],
    bs: {hp: 90, at: 100, df: 105, sa: 145, sd: 110, sp: 20},
    weightkg: 320.5,
    abilities: {0: 'Sheer Force'},
  ...
  'Farfetch\u2019d-Mega': {
    types: ['Flying', 'Dark'],
    bs: {hp: 65, at: 123, df: 82, sa: 76, sd: 82, sp: 108},
    weightkg: 15,
  ...
  'Garchomp-Mega': {
    types: ['Dragon', 'Ground'],
    bs: {hp: 108, at: 170, df: 110, sa: 120, sd: 90, sp: 92},
    weightkg: 95,
    abilities: {0: 'Sheer Force'},
  ...
  'Granbull-Mega': {
    types: ['Fairy', 'Dark'],
    bs: {hp: 90, at: 163, df: 107, sa: 47, sd: 78, sp: 108},
    abilities: {0: 'Berserk'},
    weightkg: 48.7,
  ...
  'Lucario-Mega': {
    types: ['Fighting', 'Psychic'],
    bs: {hp: 70, at: 125, df: 93, sa: 135, sd: 85, sp: 112},
    weightkg: 57.5,
  ...
  'Metagross-Mega': {
    types: ['Steel', 'Psychic'],
    bs: {hp: 80, at: 155, df: 140, sa: 100, sd: 110, sp: 100},
    weightkg: 942.9,
  ...
  'Salamence-Mega': {
    types: ['Dragon', 'Flying'],
    bs: {hp: 95, at: 110, df: 135, sa: 145, sd: 100, sp: 115},
    weightkg: 112.6,
    abilities: {0: 'Intimidate'},
  ...
  'Trevenant-Autumn': {
    bs: {hp: 91, at: 110, df: 83, sa: 65, sd: 82, sp: 71},
    weightkg: 71,
...
const SM_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Vikavolt: {
    types: ['Bug', 'Electric'],
    bs: {hp: 77, at: 105, df: 90, sa: 145, sd: 90, sp: 93},
    weightkg: 45,
    abilities: {0: 'Levitate'},
...
const SS_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Coalossal: {
    types: ['Rock', 'Fire'],
    bs: {hp: 120, at: 80, df: 120, sa: 80, sd: 90, sp: 25},
    weightkg: 310.5,
    abilities: {0: 'Steam Engine'},
  ...
  Hatterene: {
    types: ['Psychic', 'Fairy'],
    bs: {hp: 87, at: 110, df: 100, sa: 146, sd: 108, sp: 49},
    weightkg: 5.1,
    abilities: {0: 'Healer'},
  ...
  'Mr. Rime': {
    types: ['Ice', 'Psychic'],
    bs: {hp: 80, at: 65, df: 75, sa: 110, sd: 100, sp: 100},
    weightkg: 58.2,
  ...
  Runerigus: {
    types: ['Ground', 'Ghost'],
    bs: {hp: 68, at: 95, df: 145, sa: 45, sd: 105, sp: 20},
    weightkg: 66.6,
    abilities: {0: 'Wandering Spirit'},
  },
  Saharaja: {
...
const SV_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Armarouge: {
    types: ['Fire', 'Psychic'],
    bs: {hp: 100, at: 70, df: 115, sa: 135, sd: 85, sp: 95},
    weightkg: 85,
    abilities: {0: 'Flash Fire'},
  },
  Baxcalibur: {
  ...
  Bulbick: {
    types: ['Water', 'Electric'],
    bs: {hp: 60, at: 25, df: 40, sa: 75, sd: 65, sp: 10},
		weightkg: 3.1,
    abilities: {0: 'Dazzling'},
    nfe: true,
  },
  ...
  Ceruledge: {
    types: ['Fire', 'Ghost'],
    bs: {hp: 90, at: 135, df: 85, sa: 70, sd: 115, sp: 105},
    weightkg: 62,
    abilities: {0: 'Flash Fire'},
  },
  Cetitan: {
  ...
  Devdraco: {
    types: ['Normal', 'Dragon'],
    bs: {hp: 55, at: 75, df: 80, sa: 75, sd: 80, sp: 60},
    weightkg: 47.0,
    abilities: {0: 'Intimidate'},
    nfe: true,
  },
  ...
  Gigachelonian: {
    types: ['Bug', 'Rock'],
    bs: {hp: 60, at: 70, df: 180, sa: 60, sd: 180, sp: 10},
    weightkg: 50.5,
    abilities: {0: 'Dry Skin'},
  },
  Gimmighoul: {
  ...
  Goopli: {
    types: ['Fire'],
    bs: {hp: 60, at: 50, df: 35, sa: 54, sd: 70, sp: 21},
    weightkg: 10,
    abilities: {0: 'Illuminate'},
    nfe: true,
  },
  ...
  'Iron Bundle': {
    types: ['Ice', 'Water'],
    bs: {hp: 76, at: 80, df: 114, sa: 104, sd: 80, sp: 116},
    weightkg: 11,
    gender: 'N',
  ...
  'Iron Thorns': {
    types: ['Rock', 'Electric'],
    bs: {hp: 100, at: 134, df: 110, sa: 70, sd: 94, sp: 72},
    weightkg: 303,
    gender: 'N',
    abilities: {0: 'Quark Drive'},
  },
  ...
  'Iron Valiant': {
    types: ['Fairy', 'Fighting'],
    bs: {hp: 74, at: 125, df: 90, sa: 120, sd: 60, sp: 114},
    weightkg: 35,
    gender: 'N',
    abilities: {0: 'Quark Drive'},
  },
  ...
  Lampoct: {
    types: ['Water', 'Electric'],
    bs: {hp: 70, at: 40, df: 50, sa: 85, sd: 70, sp: 55},
    weightkg: 13,
    abilities: {0: 'Dazzling'},
    nfe: true,
  },
  ...
  Octolure: {
    types: ['Water', 'Electric'],
    bs: {hp: 82, at: 50, df: 62, sa: 150, sd: 84, sp: 92},
    weightkg: 34.3,
    abilities: {0: 'Dazzling'}
  },
  Ogerpon: {
  ...
  'Slither Wing': {
    types: ['Bug', 'Fighting'],
    bs: {hp: 85, at: 135, df: 99, sa: 60, sd: 105, sp: 86},
    weightkg: 92,
    gender: 'N',
    abilities: {0: 'Protosynthesis'},
  },
  Slugoliath: {
    types: ['Fire', 'Poison'],
    bs: {hp: 90, at: 90, df: 85, sa: 94, sd: 120, sp: 51},
    weightkg: 20.0,
    abilities: {0: 'Lava Surfer'}
  },
  Smoliv: {
    types: ['Grass', 'Normal'],
  ...
  Sotanaht: {
    types: ['Ghost', 'Fire'],
    bs: {hp: 104, at: 96, df: 91, sa: 54, sd: 93, sp: 90},
		weightkg: 55,
    abilities: {0: 'Aftermath'},
  },
  Spidops: {
  ...
  Tindraco: {
    types: ['Normal', 'Dragon'],
    bs: {hp: 45, at: 55, df: 55, sa: 55, sd: 55, sp: 45},
    weightkg: 33.6,
    abilities: {0: 'Oblivious'},
    nfe: true,
  },
